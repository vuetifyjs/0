...
**43 components, 72 composables, 27 utilities** across 15 categories. Compound-component APIs with WAI-ARIA semantics.
...
| Focus containment (non-native dialog, drawer) | `useFocusTrap` | system |
...
- `useFocusTrap` — Confines sequential keyboard navigation (Tab / Shift+Tab) to the subtree of a single root element, focuses into it on activation, and hands focus back to the previously focused element on deactivation.
