...
<template>
  <div class="flex flex-col gap-4">
    ...
    <!-- The manifest, above the app preview: the thing being built here is a file, and this
         ...
         never the toolbar, so "src/main.ts … N lines" stays legible against a flat bar. This
         component only ever mounts on routes with a preview aside — step 1 has none, so it
         never reaches here (see AppShell.vue). -->
    <div
