...
<template>
  <div class="p-8 max-w-3xl">
    ...
    <p class="mb-4">
      ...
      features like theming and locale. Design systems share the same
      headless core, so switching between them means changing the visual
