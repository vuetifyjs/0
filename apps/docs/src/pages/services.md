...
> [!TIP]
> Need answers, not a build? Start with Galaxy. Most teams don't need a full engagement — they need someone with the source tree open who can answer in hours instead of days.

## Project Builds {#projects}

Fixed price, fixed scope. Three flavors covering most of what people ask for. AI does the typing — you're paying for taste, edge-case knowledge, and a finished thing on your repo instead of a half-built one.

<ServicesProjectTiers />

<div class="flex justify-center my-6">
  <a class="btn-primary inline-flex items-center gap-1.5" href="https://calendly.com/vuetify/conference-call-30-min" rel="noopener" target="_blank">
    Book an intro call to scope a project
