...
Orchestrator that composes `createInput` + `createNumeric` + `Intl.NumberFormat`. Manages a numeric value with locale-aware formatting, parsing, step snapping, and field validation.
