---
title: Grok Bot - Vuetify0 Engineer setup
features:
  label: Grok Bot
  order: 1.5
  level: 1
meta:
- name: description
  content: Paste-ready Grok Bot setup prompts that connect GitHub, dry-run a v0 task, and save a Vuetify0 Engineer — plus identity fields for Claude and Cursor.
- name: keywords
  content: Grok Bot, AI agent, Vuetify0, setup prompt, Cursor, Claude, SKILL.md, MCP
related:
