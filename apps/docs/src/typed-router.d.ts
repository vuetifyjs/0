...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/composables/registration/use-proxy-model': RouteRecordInfo<'/composables/registration/use-proxy-model', '/composables/registration/use-proxy-model', Record<never, never>, Record<never, never>>,
    ...
    '/composables/system/use-layout': RouteRecordInfo<'/composables/system/use-layout', '/composables/system/use-layout', Record<never, never>, Record<never, never>>,
