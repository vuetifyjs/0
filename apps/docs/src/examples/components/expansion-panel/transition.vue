...
<template>
  ...
  >
    ...
    >
      ...
      >
        <ExpansionPanel.Cue
          class="inline-flex items-center justify-center w-5 text-sm text-on-surface opacity-60 transition-transform duration-200 data-[state=open]:rotate-90 data-[state=open]:text-primary"
        >
          ▶
        </ExpansionPanel.Cue>
