    ...
    <div class="grid grid-cols-2 gap-4 mt-4">
      <div class="p-4 border border-error rounded">
        <div class="flex items-baseline justify-between">
          <h3 class="text-error font-semibold">Stored snapshot</h3>
          <p class="text-2xl font-bold text-error">{{ snapshot.length }}</p>
        </div>
      ...
      <div class="p-4 border border-success rounded">
        <div class="flex items-baseline justify-between">
          <h3 class="text-success font-semibold">proxy.values</h3>
          <p class="text-2xl font-bold text-success">{{ proxy.values.length }}</p>
        </div>
