...
export interface UseAskReturn {
  ...
  stop: () => void
  /** Request focus on the visible input (floating or sheet) */
  focus: () => void
 ...
 *
 * @returns Ask state and controls
 *
 * @example
 * ```vue
 ...
 *  const ask = useAsk()
 *
 *  // Focus the visible input (floating or sheet)
 *  ask.focus()
 *
 *  // Submit a question
 *  ask.ask('How do I use this component?')
 * </script>
 * ```
 */
