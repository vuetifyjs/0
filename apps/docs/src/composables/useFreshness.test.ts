...
describe('scoreToColor', () => {
  it('maps score 100 to pure success', () => {
    expect(scoreToColor(100)).toBe('color-mix(in srgb, var(--v0-success), var(--v0-error) 0%)')
  })

  it('maps score 0 to pure error', () => {
    expect(scoreToColor(0)).toBe('color-mix(in srgb, var(--v0-success), var(--v0-error) 100%)')
  })

  it('maps score 50 to halfway mix', () => {
    expect(scoreToColor(50)).toBe('color-mix(in srgb, var(--v0-success), var(--v0-error) 50%)')
  })

  it('clamps above 100 and below 0', () => {
    expect(scoreToColor(150)).toBe('color-mix(in srgb, var(--v0-success), var(--v0-error) 0%)')
    expect(scoreToColor(-10)).toBe('color-mix(in srgb, var(--v0-success), var(--v0-error) 100%)')
  })
})
