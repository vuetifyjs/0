...
<template>
  <div class="not-prose my-4 border border-divider rounded-lg bg-surface overflow-hidden">
    ...
    <button
      v-if="dense && !open"
      :aria-expanded="false"
      class="w-full m-0 px-3 py-2 bg-transparent border-0 border-t border-solid border-divider text-left cursor-pointer hover:bg-surface-tint/50 focus-visible:bg-surface-tint focus-visible:outline-none"
      type="button"
      @click="open = true"
    >
