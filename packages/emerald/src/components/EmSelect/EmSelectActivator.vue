<script lang="ts">
  // Framework
  import { SelectActivator } from '@vuetify/v0'
...
<template>
  <SelectActivator class="emerald-select__activator">
...
.emerald-select__activator:hover:not([data-select-open]) {
...
.emerald-select__activator[data-select-open] {
  outline: none;
