<script lang="ts">
  ...
  export interface EmTextareaClearProps {
    ariaLabel?: string
  }
</script>

<script setup lang="ts">
  defineOptions({ name: 'EmTextareaClear' })

  const { ariaLabel = 'Clear' } = defineProps<EmTextareaClearProps>()
