...
export type { EmAvatarBadgeProps } from './EmAvatarBadge.vue'
export { default as EmAvatarBadge } from './EmAvatarBadge.vue'

export type { EmAvatarFallbackProps } from './EmAvatarFallback.vue'
export { default as EmAvatarFallback } from './EmAvatarFallback.vue'

export type { EmAvatarGroupProps } from './EmAvatarGroup.vue'
export { default as EmAvatarGroup } from './EmAvatarGroup.vue'
