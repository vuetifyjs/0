...
describe('useDate', () => {
  describe('vuetify0DateAdapter', () => {
    ...
    describe('week utilities', () => {
      ...
      it.each([
        // ['2025-01-07T10:30:00', '2025-01-07T10:00:00', 0], // currently 1
        // ['2025-01-07T10:59:59', '2025-01-07T10:00:00', 0], // currently 1
        ['2025-01-07T11:00:00', '2025-01-07T10:00:00', 1],
        // ['2025-01-07T11:59:59', '2025-01-07T10:00:00', 1], // currently 2
        ...
        // symmetry
        // ['2025-01-07T10:00:00', '2025-01-07T10:30:00', 0], // currently -0
        // ['2025-01-07T10:00:00', '2025-01-07T10:59:59', 0], // currently -1
        ['2025-01-07T10:00:00', '2025-01-07T11:00:00', -1],
        // ['2025-01-07T10:00:00', '2025-01-07T11:59:59', -1], // currently -2
      ...
      it.each([
        ...
        // symmetry
        // ['2025-01-07', '2025-01-08', 0], // currently -1
        // ['2025-01-07', '2025-01-20', -1], // currently -2
        ['2025-01-07', '2025-01-21', -2],
        // ['2025-01-07', '2025-01-22', -2], // currently -3
  ...
  describe('createDate', () => {
    it('should create date context with adapter', () => {
      ...
      expect(dateContext.adapter).toBe(adapter)
