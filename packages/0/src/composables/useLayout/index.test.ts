...
describe('useLayout inside component', () => {
  ...
  it('registers height and width in browser', () => {
    ...
    mountedComponent.vm.context.register({ id: 'Component1', position: 'top', height: 32 })
    mountedComponent.vm.context.register({ id: 'Component2', position: 'left', width: 128 })
...
describe('useLayout outside component', () => {
  it('registers components', () => {
    const context = createLayout()
    context.register({ id: 'Component1', position: 'top', height: 32 })
    context.register({ id: 'Component2', position: 'bottom', height: 64 })
  ...
  it('calculates bound', () => {
    const context = createLayout()
    context.register({ id: 'Component1', position: 'top', height: 32 })
    context.register({ id: 'Component2', position: 'bottom', height: 128 })
    context.register({ id: 'Component3', position: 'left', width: 64 })
