...
describe('createSelection', () => {
  ...
  describe('useSelection', () => {
    ...
    describe('apply', () => {
      it('should sync selection to passed values in multiple mode', () => {
        const selection = createSelection({ multiple: true })
        selection.onboard([
          { id: 'a', value: 'A' },
          { id: 'b', value: 'B' },
        ...
        // Apply replaces the selection — only ticket with value 'C' kept
        selection.apply(['C'])
      ...
      it('should add new values without dropping matching ones in multiple mode', () => {
        const selection = createSelection({ multiple: true })
        selection.onboard([
          { id: 'a', value: 'A' },
          { id: 'b', value: 'B' },
      ...
      it('should switch to single value in non-multiple mode', () => {
        const selection = createSelection()
        selection.onboard([
          { id: 'a', value: 'A' },
          { id: 'b', value: 'B' },
      ...
      it('should clear selection when applying empty array in non-multiple mode', () => {
        const selection = createSelection()
        selection.onboard([{ id: 'a', value: 'A' }])
        selection.select('a')
      ...
      it('should respect explicit multiple option override', () => {
        const selection = createSelection()
        selection.onboard([
          { id: 'a', value: 'A' },
          { id: 'b', value: 'B' },
        ...
        selection.apply(['A', 'B'], { multiple: true })
