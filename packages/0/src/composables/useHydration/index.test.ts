...
describe('createHydration', () => {
  ...
  describe('useHydration SSR', () => {
    ...
    it('should start createHydration with isHydrated false for SSR', async () => {
    ...
    it('should have isHydrated and isSettled true on createFallbackHydration', async () => {
    ...
    it('should make createFallbackHydration hydrate and settle safe no-ops', async () => {
      const { createFallbackHydration } = await import('./index')
      const context = createFallbackHydration()
    ...
    it('should return fallback from useHydration when no Vue instance exists', async () => {
    ...
    it('should be safe to call hydrate() during SSR', async () => {
      const { createHydration: createHydrationSSR } = await import('./index')
      const context = createHydrationSSR()
    ...
    it('should work with createHydrationPlugin during SSR', async () => {
    ...
    it('should work with createHydrationContext during SSR', async () => {
