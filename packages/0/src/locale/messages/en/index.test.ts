...
describe('locale/messages/en', () => {
  ...
  it('should export an English aria-string catalog for every v0 component namespace', () => {
    ...
    for (const key of ['AlertDialog', 'Avatar', 'Breadcrumbs', 'Button', 'Carousel', 'Combobox', 'DataGrid', 'Dialog', 'Input', 'NumberField', 'OverlayPanel', 'Pagination', 'Rating', 'Slider', 'Snackbar', 'Splitter']) {
