...
const UTILITIES = [
  'UNSAFE_KEYS', 'V0Error', 'apca', 'clamp', 'foreground', 'hexToRgb', 'instanceExists', 'instanceName', 'isArray', 'isBoolean', 'isElement', 'isFunction', 'isNaN', 'isNull', 'isNullOrUndefined', 'isNumber', 'isObject', 'isPrimitive', 'isString', 'isSymbol', 'isThenable', 'isUndefined', 'isV0Error', 'mergeDeep', 'pxToNumber', 'range', 'resolveIds', 'resolveIndexes', 'rgbToHex', 'useId',
]
