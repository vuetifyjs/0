...
<script lang="ts">
  ...
  export interface ExpansionPanelGroupProps extends AtomProps {
  ...
  export interface ExpansionPanelGroupSlotProps {
  ...
  export const [useExpansionPanelGroup, provideExpansionPanelGroup] = createContext<SelectionContext<SelectionTicket>>()
</script>
...
<script lang="ts" setup generic="T = unknown">
  defineOptions({ name: 'ExpansionPanelGroup' })
  ...
  const {
    ...
    mandatory = false,
    multiple = false,
  } = defineProps<ExpansionPanelGroupProps>()
  ...
  provideExpansionPanelGroup(namespace, selection)
</script>
