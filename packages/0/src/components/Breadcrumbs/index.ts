...
export { provideBreadcrumbsEllipsis, useBreadcrumbsEllipsis } from './BreadcrumbsEllipsis.vue'
...
export type { BreadcrumbsEllipsisContext, BreadcrumbsEllipsisProps, BreadcrumbsEllipsisSlotProps } from './BreadcrumbsEllipsis.vue'
