    ...
    describe('namespace isolation', () => {
      it('should isolate groups with different namespaces', async () => {
        ...
        mount(defineComponent({
          render: () => [
            h(Checkbox.Group as any, { namespace: 'v0:ns-1' }, () =>
              h(Checkbox.Root as any, { value: 'a', groupNamespace: 'v0:ns-1' }, {
                default: (p: any) => {
                  group1Props = p
                  return 'A'
                },
            ...
            h(Checkbox.Group as any, { namespace: 'v0:ns-2' }, () =>
              h(Checkbox.Root as any, { value: 'b', groupNamespace: 'v0:ns-2' }, {
                default: (p: any) => {
                  group2Props = p
                  return 'B'
                },
