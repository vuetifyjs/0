 ...
 *
 * @see https://0.vuetifyjs.com/components/alert-dialog
 *
 * @example
 * ```vue
...
export const AlertDialog = {
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogactivator
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogcontent
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogtitle
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogdescription
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogcancel
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogclose
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
   ...
   *
   * @see https://0.vuetifyjs.com/components/alert-dialog#alertdialogaction
   *
   * @example
   * ```vue
   * <script lang="ts" setup>
