...
export interface UseSettingsReturn {
  ...
  reduceMotion: ShallowRef<HelixSettings['reduceMotion']>
  packageManager: ShallowRef<HelixSettings['packageManager']>
...
// Create context
const [useSettingsContext, provideSettingsContext] = createContext<UseSettingsReturn>('helix:settings')

/** Load a setting from storage into a ref */
function load<T> (
  storage: StorageContext,
  key: keyof HelixSettings,
  target: ShallowRef<T>,
) {
...
function createSettingsContext (): UseSettingsReturn {
  ...
  const reduceMotion = shallowRef<HelixSettings['reduceMotion']>(DEFAULTS.reduceMotion)
  const packageManager = shallowRef<HelixSettings['packageManager']>(DEFAULTS.packageManager)
