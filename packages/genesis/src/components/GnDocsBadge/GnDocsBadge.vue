<script lang="ts">
  ...
  export interface GnDocsBadgeProps {
    /** CSS color for text and mixed background (e.g. `var(--v0-primary)`). Omit for muted chrome (`--v0-on-surface-variant` text, 8% `--v0-on-surface` mix). */
    color?: string
    /** color-mix percentage for the colored background (0-100). Default 15. Ignored when `color` is omitted. */
