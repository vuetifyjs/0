...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@paper/onyx': fileURLToPath(new URL('../packages/onyx/src', import.meta.url)),
      // internal
      '#v0': fileURLToPath(new URL('../packages/0/src', import.meta.url)),
      '#paper': fileURLToPath(new URL('../packages/paper/src', import.meta.url)),
      '#onyx': fileURLToPath(new URL('../packages/onyx/src', import.meta.url)),
    },
  },
  build: {
    minify: false,
