  ...
  const categories: Category[] = [
    {
      ...
      items: [
        ...
        { q: 'Is the dashboard optimized for mobile use?', a: 'The dashboard shell collapses to a single column below 900px, with the rail navigation swapping to a slide-over drawer.' },
      ],
    },
    {
      id: 'security',
      ...
      items: [
        ...
        { q: 'Who can see audit logs?', a: 'Audit logs are scoped to Owner and Manager roles by default; grant a custom role read-only access from Roles & Permissions.' },
  ...
  <EmeraldShell>
    <div class="adm-faq" data-theme="emerald">
      <EmCard class="adm-faq__hero" variant="simple">
        <EmCardBody class="adm-faq__hero-body">
          ...
          <div class="adm-faq__search">
            <EmTextField v-model="search" aria-label="Search for a question" placeholder="Search for a question" />
      ...
      <section aria-label="Need more help" class="adm-faq__help">
        ...
        <h2 class="adm-faq__help-title">Need More Help?</h2>
        ...
        <div class="adm-faq__help-grid">
          ...
          <EmCard variant="simple">
            <EmCardBody class="adm-faq__help-card">
              ...
              <p>Browse setup guides, API references, release notes, and troubleshooting playbooks to resolve common dashboard tasks independently.</p>
