...
<template>
  ...
  <div class="onyx-exhibit mt-3">
    <p class="onyx-hallmark onyx-exhibit__caption">Native &lt;dialog&gt;, mode="default"</p>
  ...
  <div class="onyx-exhibit mt-3">
    <p class="onyx-hallmark onyx-exhibit__caption">mode="sheet", docks below 768px</p>
  ...
  <div class="onyx-exhibit mt-3">
    <p class="onyx-hallmark onyx-exhibit__caption">Default · dismissible · with action</p>
